...
namespace Lab2ICTP.Controllers
{
    ...
    public class GamesGenresController : ControllerBase
    {
        ...
        public GamesGenresController(DBGameContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != gamesGenres.GamesGenresId)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<GamesGenres>> PostGamesGenres(GamesGenres gamesGenres)
        {
            ...
            return CreatedAtAction("GetGamesGenres", new { id = gamesGenres.GamesGenresId }, gamesGenres);
        }
        ...
        {
            return _context.GamesGenres.Any(e => e.GamesGenresId == id);
        }
    }
}
